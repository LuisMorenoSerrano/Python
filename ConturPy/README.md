...
modern Fortran by F.-L. Zavalan in their [GitHub repository](https://github.com/aldorona/contur), many thanks to F. Zavalan and A. Rona.
...
|ZO|1|Compressibility factor for axisymmetric nozzle. Untested: half distance (in) between walls and assumed compressibility factor of 1|
...
|NT|41|Number of points on axis IE (see Sivells' paper). Make sure abs(LR) + abs(NT) <= 149. Must be odd.|
